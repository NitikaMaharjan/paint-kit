...
export default function AddTemplate(props) {
  ...
  const handleSaveTemplate = async(e)=> {
    ...
    if (validateInputValue()){
      try{
        const response = await fetch(`http://localhost:5000/api/template/template/savetemplate`, {
          method: "POST",
        ...
        if(json.success){
          props.setShowAddTemplateModal(false);
  ...
  return (
    <div className="auth-form-box">
      <h1 style={{padding: "8px 0px", fontSize: "14px", textAlign: "center", borderBottom: "1px solid black", backgroundColor: "#ccc"}}><b>Save template</b></h1>
