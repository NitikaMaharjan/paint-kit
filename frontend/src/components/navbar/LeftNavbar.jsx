  ...
  return (
    <div className="left-navbar">
      ...
      <div className="left-tool-bar">
        ...
        <div className="flex" style={{borderBottom: "1px solid black"}}>
          <div className={`tool ${tool==="text"?"selected-tool":""}`} style={{borderRight: "1px solid black"}} onClick={()=>{setTool("text")}}>
            <img src="/text.png" style={{height: "25px", width: "25px"}}/>
          </div>
          <div className={`tool ${tool==="line"?"selected-tool":""}`} onClick={()=>{setTool("line")}}>
            <img src="/line.png" style={{height: "20px", width: "20px"}}/>
          </div>
        </div>
        <div className="flex" style={{borderBottom: "1px solid black"}}>
          <div className={`tool ${tool==="circle"?"selected-tool":""}`} style={{borderRight: "1px solid black"}} onClick={()=>{setTool("circle")}}>
            <img src="/circle.png" style={{height: "20px", width: "20px"}}/>
          </div>
          <div className={`tool ${tool==="square"?"selected-tool":""}`} onClick={()=>{setTool("square")}}>
            <img src="/square.png" style={{height: "20px", width: "20px"}}/>
          </div>
        </div>
        <div className="flex" style={{borderBottom: "1px solid black"}}>
          <div className={`tool ${tool==="rectangle"?"selected-tool":""}`} style={{borderRight: "1px solid black"}} onClick={()=>{setTool("rectangle")}}>
            <img src="/rectangle.png" style={{height: "22px", width: "22px"}}/>
          </div>
          <div className={`tool ${tool==="triangle"?"selected-tool":""}`} onClick={()=>{setTool("triangle")}}>
        ...
        <div className="flex" style={{borderBottom: "1px solid black"}}>
          <div className={`tool ${tool==="ellipse"?"selected-tool":""}`} style={{borderRight: "1px solid black"}} onClick={()=>{setTool("ellipse")}}>
            <img src="/ellipse.png" style={{height: "18px", width: "18px"}}/>
          </div>
          <div className={`tool ${tool==="parallelogram"?"selected-tool":""}`} onClick={()=>{setTool("parallelogram")}}>
            <img src="/parallelogram.png" style={{height: "20px", width: "20px"}}/>
          </div>
        </div>
        <div className="flex" style={{borderBottom: "1px solid black"}}>
          <div className={`tool ${tool==="star"?"selected-tool":""}`} style={{borderRight: "1px solid black"}} onClick={()=>{setTool("star")}}>
            <img src="/star.png" style={{height: "20px", width: "20px"}}/>
          </div>
          <div className={`tool ${tool==="heart"?"selected-tool":""}`} onClick={()=>{setTool("heart")}}>
